...
from datetime import timedelta  # Ensure timedelta is imported if needed
from app.dependencies import get_settings
from app.models.user_model import User
from app.services.user_service import UserService
from app.services.jwt_service import decode_token  # Import for JWT validation
from app.utils.security import hash_password  # Import for password hashing and validation
...
async def test_create_user_with_valid_data(db_session, email_service):
    ...
    user = await UserService.create(db_session, user_data, email_service)  # Pass the headers with token
...
async def test_update_user_valid_data(db_session, user, user_token):
    updated_data = {"email": "updated_email@example.com"}
    # Removed the headers argument, as it's not required for this method
    updated_user = await UserService.update(db_session, user.id, updated_data)  # no headers here
